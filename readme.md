...
Для указания другого пути до конфигурационного файла можно использовать опцию "-c имя_файла" при запуске программы. 
Пример:
```bash
...
**Внимание:** Если в файле конфигурации указывается каталог, то символ "\" дублируется, например:
```bash
